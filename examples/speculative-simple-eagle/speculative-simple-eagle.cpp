...
int main(int argc, char ** argv) {
    ...
    while (true) {
        ...
        //
        llama_tokens draft = common_speculative_gen_draft_eagle(spec, params_spec, prompt_tgt, id_last, cb_data.data);
        ...
        cb_data.data.resize(ids.size() * sizeof(float) * llama_model_n_embd(model_tgt));
